...
<form action="/dashboard-dosen/{{ $dosen->id }}" method="post">
  @method('PUT')
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik" id="nik" value="{{ old('nik', $dosen->nik) }}">
        @error('nik')
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" id="no_telp" value="{{ old('no_telp', $dosen->no_telp) }}">
        @error('no_telp')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
